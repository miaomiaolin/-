<%@ Page Language="C#" MasterPageFile="~/admin/adminIndex.master" AutoEventWireup="true"
    CodeFile="AddBook.aspx.cs" Inherits="admin_AddBook" Title="添加书籍" %>
    ...
    <div class="userTab">
        <div class="userTab_in bookInfo" style="position:relative;">
            ...
            <div class="form_input" style="position:relative;z-index: 3;">
                ...
                <br />
                <button class="btn btn-open" id="addBookBtn" onserverclick="addBookBtn_ServerClick" runat="server">
                    提交</button>
                <button class="btn btn-close">重置</button>
            </div>
            <div class="bookImg">
                    <div class="bookPic" style="position:relative">
                        <img id="upImages" src="../img/book1.jpg" alt="上传图片"/>
